...
所有数据由用户自己录入，初始为空。系统不预填任何虚拟数据——店铺、菜品、饮食记录均来自真实使用。详见 `tests/test_log.md`。

## 迭代升级

在6天真实使用中，通过5步迭代法解决了3个核心痛点：

1. **智能推荐理由引擎** — 推荐不再是冷冰冰的"评分X星"，而是"3天没吃+你给过5星+预算内"
2. **场景化加餐推荐** — 支持运动日/周末/加餐/夜宵
3. **个性化学习** — 从历史记录中学习真实偏好，推荐越来越懂你

详见 `iteration/upgrade_plan.md`
